...
export default function Services() {
  return (
    <section
      id="services"
      className="relative container h-screen pt-12 bg-black flex flex-col justify-center space-y-6 mx-auto"
    >
      ...
      {/* Services cards */}
      <div className="container flex justify-center items-center flex-wrap gap-y-6">
